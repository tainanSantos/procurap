...
class _PropertyPageState
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          padding:
                              EdgeInsets.only(left: 15, top: 25, bottom: 5),
                          child: Text(
                            "Destaques",
                            style: TextStyle(
  ...
  Widget cardCustom({String title, String description, String urlImage}) =>
      GestureDetector(
        onTap: () {},
        child: Card(
  ...
  Widget cardCustom2({String title, String description, String urlImage}) =>
      GestureDetector(
        onTap: () {},
        child: Card(
